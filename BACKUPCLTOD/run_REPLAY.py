...
if __name__ == '__main__':
    ...
    # parser.opt_list('--task_type', type=str, default="E2E", options=["DST","NLG","INTENT"], tunable=True)
    parser.opt_list('--dataset_list', type=str, default="SGD", options=["SGD,TM19,TM20,MWOZ"], tunable=True)
    # parser.opt_list('--episodic_mem_size', default=1, type=int, options=[10, 50, 100, 500], tunable=True)
    parser.opt_list('--episodic_mem_size', default=1, type=int, options=[100000], tunable=True)
