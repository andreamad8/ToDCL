...
if __name__ == '__main__':
    ...
    parser.add_argument("--CL", type=str, default="LAML", help="CL strategy used")
    ...
    parser.opt_list('--percentage_LAML', default=100, type=int, options=[200], tunable=True)
    # parser.opt_list('--seed', default=1, type=int, options=[1,2,4], tunable=True)
