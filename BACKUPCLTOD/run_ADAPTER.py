...
if __name__ == '__main__':
    ...
    parser.opt_list("--bottleneck_size", type=int, default=300,options=[150,200,250,300], tunable=True)
    ...
    # parser.opt_list('--seed', default=1, type=int, options=[3], tunable=True)
